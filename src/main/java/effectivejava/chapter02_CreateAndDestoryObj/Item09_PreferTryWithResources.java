...
public class Item09_PreferTryWithResources {
    ...
    public static void main(String[] args) {
        try {
            String res = firstLineOfFileV2("/Users/17hao/IdeaProjects/javacode/src/main.effectivejava/chapter02_CreateAndDestoryObj/Item09_PreferTryWithResources.java");
